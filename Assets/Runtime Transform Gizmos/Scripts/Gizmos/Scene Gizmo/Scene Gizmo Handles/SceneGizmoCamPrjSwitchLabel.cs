        ...
        public void OnGUI()
        {
            ...
            if (sgLookAndFeel.IsCamPrjSwitchLabelVisible)
            {
                    ...
                    !RTFocusCamera.Get.IsDoingProjectionSwitch)
                {
                    ...
                    UnityEngine.GUI.DrawTexture(drawRect, labelTexture);
                    GUIEx.PopColor();
                }
                else
                {
                    ...
                    drawRect.center = new Vector2(drawRect.center.x, Screen.height - 1 - _labelQuad.Center.y);
                    UnityEngine.GUI.DrawTexture(drawRect, sourceLabelTexture);
                    GUIEx.PopColor();
                    ...
                    drawRect.center = new Vector2(drawRect.center.x, Screen.height - 1 - _labelQuad.Center.y);
                    UnityEngine.GUI.DrawTexture(drawRect, destLabelTexture);
                    GUIEx.PopColor();
                }
            }
        }
